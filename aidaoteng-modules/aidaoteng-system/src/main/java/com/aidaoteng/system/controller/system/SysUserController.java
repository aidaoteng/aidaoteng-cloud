...
import com.aidaoteng.common.excel.core.ExcelResult;
...
import com.aidaoteng.system.domain.vo.*;
import com.aidaoteng.system.listener.SysUserImportListener;
...
public class SysUserController extends BaseController {
    ...
    public R<Page<SysUserVo>> list(SysUserBo user, PageQuery pageQuery) {
        Page<SysUserVo> page = userService.selectPageUserList(user, pageQuery);
        return R.ok(page);
    }
