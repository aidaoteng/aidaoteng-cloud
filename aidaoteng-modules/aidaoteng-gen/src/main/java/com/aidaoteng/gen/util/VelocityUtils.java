package com.aidaoteng.gen.util;
    ...
    public static HashSet<String> getImportList(GenTable genTable) {
        ...
        for (GenTableColumn column : columns) {
            if (!column.isSuperColumn() && GenConstants.TYPE_DATE.equals(column.getJavaType())) {
                ...
                importList.add("com.aidaoteng.common.translation.annotation.Translation");
                importList.add("com.aidaoteng.common.translation.constant.TransConstant");
            }
        }
        return importList;
    }
